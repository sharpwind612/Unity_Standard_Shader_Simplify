...
{
    internal class MADRoleShaderGUI : ShaderGUI
    {
        ...
        private static class Styles
        {
            ...
            public static GUIContent cubeMapText = new GUIContent("Cubemap", "Cubemap (RGB)");
            //public static GUIContent ambientText = new GUIContent("AmbientStrength", "Occlusion (G)");
            //public static GUIContent ambientText = new GUIContent("Ambient", "Ambient (RGB)");
        ...
        MaterialProperty cubeMapStrength = null;
        MaterialProperty sampleLOD = null;
        ...
        void DoAmbientArea()
        {
            m_MaterialEditor.TexturePropertySingleLine(Styles.cubeMapText, cubeMap, cubeMapStrength);
            m_MaterialEditor.RangeProperty(sampleLOD, "Sample LOD");
            m_MaterialEditor.ColorProperty(ambient, "Ambient Color");
            m_MaterialEditor.RangeProperty(ambientStrength, "Ambient Strength");
        }
